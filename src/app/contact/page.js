      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="slide-in">
            <h1 className="text-4xl font-bold mb-8 text-gradient">Get in Touch</h1>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
                />
              </div>
              <div>
              ...
              <button
                ...
                className={`w-full py-3 px-6 rounded-md font-medium transition hover-scale
                  ${isSubmitting 
          ...
          <div className="fade-in">
            <div className="bg-gray-900 p-8 rounded-lg">
              <h2 className="text-2xl font-bold mb-6 glow-text">Contact Information</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0">
                    <div className="h-10 w-10 bg-gradient-to-r from-pink-500 to-blue-500 rounded-full flex items-center justify-center">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">contact@rtfashion.com</p>
                  </div>
                </div>
